...
package com.artemis.backends.gwt.emu.com.artemis.utils.reflect;
...
//		return c.getPackage().getName() + "." + c.getSimpleName();
	 ...
	 * parameter types. */
	static public com.artemis.utils.reflect.Constructor getConstructor ( Class c, Class... parameterTypes) throws ReflectionException {
		try {
	 ...
	 * types. */
	static public com.artemis.utils.reflect.Constructor getDeclaredConstructor ( Class c, Class... parameterTypes) throws ReflectionException {
		try {
	 ...
	 * types. */
	static public com.artemis.utils.reflect.Method getMethod ( Class c, String name, Class... parameterTypes) throws ReflectionException {
		try {
	...
	static public com.artemis.utils.reflect.Method getDeclaredMethod ( Class c, String name, Class... parameterTypes) throws ReflectionException {
		try {
	...
	static public com.artemis.utils.reflect.Field getField ( Class c, String name) throws ReflectionException {
		try {
	...
	static public com.artemis.utils.reflect.Field getDeclaredField ( Class c, String name) throws ReflectionException {
		try {
	...
	static public com.artemis.utils.reflect.Annotation getDeclaredAnnotation ( Class c, Class<? extends java.lang.annotation.Annotation> annotationType) {
		java.lang.annotation.Annotation[] annotations = ReflectionCache.getType(c).getDeclaredAnnotations();
		for (java.lang.annotation.Annotation annotation : annotations) {
			if (annotation.annotationType().equals(annotationType)) {
