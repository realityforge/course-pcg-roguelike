...
class TimSort<T>
{
  ...
  private TimSort( @Nonnull final T[] a, final Comparator<? super T> c )
  {
    ...
    final T[] newArray =
      (T[]) new Object[ len < 2 * INITIAL_TMP_STORAGE_LENGTH ? len >>> 1 : INITIAL_TMP_STORAGE_LENGTH ];
    tmp = newArray;
  ...
  private static <T> void binarySort( @Nonnull final T[] a,
                                      final int lo,
                                      final int hi,
                                      int start,
                                      @Nonnull final Comparator<? super T> c )
  {
   ...
   */
  private static <T> int countRunAndMakeAscending( final T[] a,
                                                   final int lo,
                                                   final int hi,
                                                   @Nonnull final Comparator<? super T> c )
  {
